...
//sampler sampler deviceTexSmpSC 0:23
...
//texture texture2D deviceTex 0:4:0:23
...
//texture texture2DArray deviceTexArrSC 0:35:0:23
...
//spec_const bool deviceTexHasSwappedViews 43 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_deviceTex 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_deviceTex 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 89 -1
//spec_const int baseTexLayout 90 0
//spec_const int deviceTexLayout 91 0
...
uniform sampler2DArray deviceTexArrSC;
...
int deviceTexGetStereoViewIndex()
{
int l9_0;
...
vec2 l9_2=l9_0-Port_Center_N010;
vec2 l9_3=(l9_2*Port_Scale_N010)+Port_Center_N010;
vec4 l9_4;
#if (deviceTexLayout==2)
{
bool l9_5=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_deviceTex)!=0));
float l9_6=l9_3.x;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x);
float l9_7=l9_6;
float l9_8=l9_3.y;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y);
float l9_9=l9_8;
vec2 l9_10;
float l9_11;
#if (SC_USE_UV_MIN_MAX_deviceTex)
{
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0);
}
#endif
float l9_13=l9_7;
float l9_14=1.0;
sc_ClampUV(l9_13,deviceTexUvMinMax.x,deviceTexUvMinMax.z,l9_12,l9_14);
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0);
}
#endif
float l9_18=l9_9;
float l9_19=l9_16;
sc_ClampUV(l9_18,deviceTexUvMinMax.y,deviceTexUvMinMax.w,l9_17,l9_19);
l9_11=l9_19;
...
#endif
vec2 l9_20=sc_TransformUV(l9_10,(int(SC_USE_UV_TRANSFORM_deviceTex)!=0),deviceTexTransform);
float l9_21=l9_20.x;
float l9_22=l9_11;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x,l9_5,l9_22);
float l9_23=l9_20.y;
float l9_24=l9_22;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y,l9_5,l9_24);
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),deviceTexLayout,deviceTexGetStereoViewIndex());
vec4 l9_27=texture(deviceTexArrSC,l9_26,0.0);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_28=mix(deviceTexBorderColor,l9_27,vec4(l9_25));
}
#else
{
l9_28=l9_27;
...
#else
{
bool l9_29=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_deviceTex)!=0));
float l9_30=l9_3.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x);
float l9_31=l9_30;
float l9_32=l9_3.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
#if (SC_USE_UV_MIN_MAX_deviceTex)
...
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0);
}
#endif
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,deviceTexUvMinMax.x,deviceTexUvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0);
}
#endif
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,deviceTexUvMinMax.y,deviceTexUvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_deviceTex)!=0),deviceTexTransform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x,l9_29,l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y,l9_29,l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),deviceTexLayout,deviceTexGetStereoViewIndex());
vec4 l9_51=texture(deviceTex,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_52=mix(deviceTexBorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
#if (baseTexLayout==2)
{
bool l9_54=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_55=l9_3.x;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_56=l9_55;
float l9_57=l9_3.y;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_58=l9_57;
vec2 l9_59;
float l9_60;
...
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_62=l9_56;
float l9_63=1.0;
sc_ClampUV(l9_62,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_61,l9_63);
float l9_64=l9_62;
float l9_65=l9_63;
bool l9_66;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_66=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_67=l9_58;
float l9_68=l9_65;
sc_ClampUV(l9_67,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_66,l9_68);
l9_60=l9_68;
...
#endif
vec2 l9_69=sc_TransformUV(l9_59,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_70=l9_69.x;
float l9_71=l9_60;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_54,l9_71);
float l9_72=l9_69.y;
float l9_73=l9_71;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_54,l9_73);
float l9_74=l9_73;
vec3 l9_75=sc_SamplingCoordsViewToGlobal(vec2(l9_70,l9_72),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_76=texture(baseTexArrSC,l9_75,0.0);
vec4 l9_77;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_77=mix(baseTexBorderColor,l9_76,vec4(l9_74));
}
#else
{
l9_77=l9_76;
...
#else
{
bool l9_78=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_79=l9_3.x;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_80=l9_79;
float l9_81=l9_3.y;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_82=l9_81;
vec2 l9_83;
float l9_84;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_86=l9_80;
float l9_87=1.0;
sc_ClampUV(l9_86,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_85,l9_87);
float l9_88=l9_86;
float l9_89=l9_87;
bool l9_90;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_90=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_90=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_91=l9_82;
float l9_92=l9_89;
sc_ClampUV(l9_91,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_90,l9_92);
l9_84=l9_92;
...
#endif
vec2 l9_93=sc_TransformUV(l9_83,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_94=l9_93.x;
float l9_95=l9_84;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_78,l9_95);
float l9_96=l9_93.y;
float l9_97=l9_95;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_78,l9_97);
float l9_98=l9_97;
vec3 l9_99=sc_SamplingCoordsViewToGlobal(vec2(l9_94,l9_96),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_100=texture(baseTex,l9_99.xy,0.0);
vec4 l9_101;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_101=mix(baseTexBorderColor,l9_100,vec4(l9_98));
}
#else
{
l9_101=l9_100;
...
#endif
float l9_102=l9_4.w*l9_53.x;
vec4 l9_103=vec4(l9_4.x,l9_4.y,l9_4.z,vec4(0.0).w);
l9_103.w=l9_102;
#if (sc_BlendMode_AlphaTest)
{
if (l9_102<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_102<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_104,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_106;
...
{
l9_108=clamp(l9_102*2.0,0.0,1.0);
}
#else
{
float l9_109;
...
{
l9_109=clamp(dot(l9_103.xyz,vec3(l9_102)),0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_111=(1.0-dot(l9_103.xyz,vec3(0.33333001)))*l9_102;
}
#else
{
float l9_112;
...
{
l9_112=(1.0-clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0))*l9_102;
}
#else
{
float l9_113;
...
{
l9_113=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0)*l9_102;
}
#else
{
float l9_114;
#if (sc_BlendMode_Add)
{
l9_114=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_115;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_115=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0)*l9_102;
}
#else
{
float l9_116;
...
{
l9_116=dot(l9_103.xyz,vec3(0.33333001))*l9_102;
}
#else
{
float l9_117;
#if (sc_BlendMode_Min)
{
l9_117=1.0-clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_118;
#if (sc_BlendMode_Max)
{
l9_118=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_118=1.0;
...
#endif
l9_106=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_103.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_107);
}
#else
{
vec4 l9_119;
...
#if (sc_FramebufferFetch)
{
vec4 l9_122=sc_readFragData0_Platform();
vec4 l9_123;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_124=l9_122;
l9_124.x=l9_122.x+_sc_framebufferFetchMarker;
l9_123=l9_124;
}
#else
{
...
#else
{
vec2 l9_125=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_126;
...
{
l9_127=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_125,sc_ScreenTextureLayout,l9_126),0.0);
}
#else
{
l9_127=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_125,sc_ScreenTextureLayout,l9_126).xy,0.0);
}
#endif
l9_121=l9_127;
}
...
{
vec4 l9_129=l9_121;
l9_129.x=l9_121.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_128=l9_129;
}
#else
{
...
#endif
vec3 l9_130=mix(l9_128.xyz,definedBlend(l9_128.xyz,l9_103.xyz).xyz,vec3(l9_102));
vec4 l9_131=vec4(l9_130.x,l9_130.y,l9_130.z,vec4(0.0).w);
l9_131.w=1.0;
l9_120=l9_131;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_132=vec4(mix(vec3(1.0),l9_103.xyz,vec3(l9_102)),l9_102);
}
#else
{
vec4 l9_133;
...
#endif
l9_133=vec4(l9_103.xyz*l9_134,l9_134);
}
#else
{
l9_133=l9_103;
...
{
l9_137=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_137=vec4(0.0);
...
vec4 l9_139=outputMotionVectorsIfNeeded(varPos,max(l9_138,vec4(0.0)));
vec4 l9_140=clamp(l9_139,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_141=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_141-0.0039215689)),min(1.0,l9_141+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_142=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_142).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_143=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_142).xy);
float l9_144=packValue(l9_143);
int l9_151=int(l9_140.w*255.0);
float l9_152=packValue(l9_151);
sc_writeFragData0Internal(vec4(packValue(l9_143),packValue(l9_143),packValue(l9_143),packValue(l9_143)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_144,packValue(l9_143),packValue(l9_143),packValue(l9_143)));
sc_writeFragData2(vec4(l9_152,packValue(l9_151),packValue(l9_151),packValue(l9_151)));
...
if (l9_160==0)
{
l9_163=texture(sc_OITAlpha0,l9_155);
l9_162=texture(sc_OITDepthLow0,l9_155);
l9_161=texture(sc_OITDepthHigh0,l9_155);
}
else
{
l9_163=vec4(0.0);
...
if (l9_160==1)
{
l9_166=texture(sc_OITAlpha1,l9_155);
l9_165=texture(sc_OITDepthLow1,l9_155);
l9_164=texture(sc_OITDepthHigh1,l9_155);
}
else
{
l9_166=l9_163;
...
if (any(notEqual(l9_164,vec4(0.0)))||any(notEqual(l9_165,vec4(0.0))))
{
int l9_167[8]=l9_156;
unpackValues(l9_164.w,l9_160,l9_167);
unpackValues(l9_164.z,l9_160,l9_167);
unpackValues(l9_164.y,l9_160,l9_167);
unpackValues(l9_164.x,l9_160,l9_167);
unpackValues(l9_165.w,l9_160,l9_167);
unpackValues(l9_165.z,l9_160,l9_167);
unpackValues(l9_165.y,l9_160,l9_167);
unpackValues(l9_165.x,l9_160,l9_167);
int l9_176[8]=l9_157;
unpackValues(l9_166.w,l9_160,l9_176);
unpackValues(l9_166.z,l9_160,l9_176);
unpackValues(l9_166.y,l9_160,l9_176);
unpackValues(l9_166.x,l9_160,l9_176);
}
l9_160++;
continue;
}
...
vec4 l9_181=texture(sc_OITFilteredDepthBoundsTexture,l9_155);
vec2 l9_182=l9_181.xy;
int l9_183;
#if (sc_SkinBonesCount>0)
{
l9_183=encodeDepth(((1.0-l9_181.x)*1000.0)+getDepthOrderingEpsilon(),l9_182);
}
#else
{
l9_183=0;
...
#endif
int l9_184=encodeDepth(viewSpaceDepth(),l9_182);
vec4 l9_185;
l9_185=l9_140*l9_140.w;
vec4 l9_186;
int l9_187=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_187<8)
{
int l9_188=l9_156[l9_187];
int l9_189=l9_184-l9_183;
bool l9_190=l9_188<l9_189;
bool l9_191;
if (l9_190)
{
l9_191=l9_156[l9_187]>0;
}
else
{
l9_191=l9_190;
...
if (l9_191)
{
vec3 l9_192=l9_185.xyz*(1.0-(float(l9_157[l9_187])/255.0));
l9_186=vec4(l9_192.x,l9_192.y,l9_192.z,l9_185.w);
}
else
{
l9_186=l9_185;
...
sc_writeFragData0Internal(l9_185,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_139,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
