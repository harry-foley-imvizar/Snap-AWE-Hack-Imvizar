...
//sampler sampler deviceTexSmpSC 0:18
...
//texture texture2D deviceTex 0:1:0:18
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_deviceTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_deviceTex 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 88 -1
//spec_const int baseTexLayout 89 0
//spec_const int deviceTexLayout 90 0
...
#endif
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_deviceTex)!=0));
float l9_3=l9_0.x;
float l9_4=l9_3;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x);
float l9_5=l9_4;
float l9_6=l9_0.y;
float l9_7=l9_6;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0);
}
#endif
float l9_12=l9_5;
float l9_13=1.0;
sc_ClampUV(l9_12,deviceTexUvMinMax.x,deviceTexUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,deviceTexUvMinMax.y,deviceTexUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_deviceTex)!=0),deviceTexTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).x,l9_2,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex).y,l9_2,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),deviceTexLayout,l9_1);
vec4 l9_26=texture2D(deviceTex,l9_25.xy,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_deviceTex)
{
l9_27=mix(deviceTexBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),baseTexLayout,l9_28);
vec4 l9_51=texture2D(baseTex,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
float l9_53=l9_27.w*l9_52.x;
vec4 l9_54=vec4(l9_27.x,l9_27.y,l9_27.z,vec4(0.0).w);
l9_54.w=l9_53;
...
#if (sc_FramebufferFetch)
{
vec4 l9_71=sc_readFragData0_Platform();
vec4 l9_72;
...
#endif
l9_70=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_74,sc_ScreenTextureLayout,l9_75).xy,0.0);
}
#endif
vec4 l9_76;
...
{
vec4 l9_77=l9_70;
l9_77.x=l9_70.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_76=l9_77;
}
#else
{
...
#endif
vec3 l9_78=mix(l9_76.xyz,definedBlend(l9_76.xyz,l9_54.xyz).xyz,vec3(l9_53));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_80=vec4(mix(vec3(1.0),l9_54.xyz,vec3(l9_53)),l9_53);
}
#else
{
vec4 l9_81;
...
#endif
l9_81=vec4(l9_54.xyz*l9_82,l9_82);
}
#else
{
l9_81=l9_54;
...
#endif
int l9_91=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_90).xy);
...
if (l9_108==0)
{
l9_111=texture2D(sc_OITAlpha0,l9_103);
l9_110=texture2D(sc_OITDepthLow0,l9_103);
l9_109=texture2D(sc_OITDepthHigh0,l9_103);
}
else
{
l9_111=vec4(0.0);
...
if (l9_108==1)
{
l9_114=texture2D(sc_OITAlpha1,l9_103);
l9_113=texture2D(sc_OITDepthLow1,l9_103);
l9_112=texture2D(sc_OITDepthHigh1,l9_103);
}
else
{
l9_114=l9_111;
...
vec4 l9_129=texture2D(sc_OITFilteredDepthBoundsTexture,l9_103);
