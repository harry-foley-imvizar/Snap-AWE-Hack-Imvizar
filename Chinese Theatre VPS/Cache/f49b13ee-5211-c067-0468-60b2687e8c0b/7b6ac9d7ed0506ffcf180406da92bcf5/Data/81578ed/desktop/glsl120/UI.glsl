...
#if (Tweak_N121)
{
vec2 l9_1=((varPackedTex.xy-Port_Center_N010)*vec2(uvScale))+Port_Center_N010;
int l9_2;
...
#else
{
l9_0=Port_Default_N032;
}
#endif
vec4 l9_27=baseColor*l9_0;
float l9_28;
#if (Tweak_N308)
{
vec2 l9_29=((varPackedTex.xy-Port_Center_N010)*vec2(uvScale))+Port_Center_N010;
int l9_30;
...
float l9_51=l9_50;
vec3 l9_52=sc_SamplingCoordsViewToGlobal(vec2(l9_47,l9_49),opacityTexLayout,l9_30);
vec4 l9_53=texture2D(opacityTex,l9_52.xy,0.0);
vec4 l9_54;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
l9_28=Port_Default_N029;
}
#endif
float l9_55=l9_27.w*l9_28;
vec4 l9_56=vec4(l9_27.x,l9_27.y,l9_27.z,vec4(0.0).w);
l9_56.w=l9_55;
#if (sc_BlendMode_AlphaTest)
{
if (l9_55<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_55<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_60=clamp(dot(l9_56.xyz,vec3(l9_55)),0.0,1.0);
}
#else
{
float l9_61;
...
{
l9_62=(1.0-dot(l9_56.xyz,vec3(0.33333001)))*l9_55;
}
#else
{
float l9_63;
...
{
l9_63=(1.0-clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0))*l9_55;
}
#else
{
float l9_64;
...
{
l9_64=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0)*l9_55;
}
#else
{
float l9_65;
#if (sc_BlendMode_Add)
{
l9_65=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_66;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_66=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0)*l9_55;
}
#else
{
float l9_67;
...
{
l9_67=dot(l9_56.xyz,vec3(0.33333001))*l9_55;
}
#else
{
float l9_68;
#if (sc_BlendMode_Min)
{
l9_68=1.0-clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_69;
#if (sc_BlendMode_Max)
{
l9_69=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_69=1.0;
...
#endif
l9_57=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_56.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_58);
}
#else
{
vec4 l9_70;
...
#endif
vec3 l9_80=mix(l9_78.xyz,definedBlend(l9_78.xyz,l9_56.xyz).xyz,vec3(l9_55));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_82=vec4(mix(vec3(1.0),l9_56.xyz,vec3(l9_55)),l9_55);
}
#else
{
vec4 l9_83;
...
#endif
l9_83=vec4(l9_56.xyz*l9_84,l9_84);
}
#else
{
l9_83=l9_56;
