...
//spec_const bool sc_CanUseTextureLod 66 0
...
//spec_const bool sc_ProxyAlphaOne 86 0
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 87 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 88 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 100 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 101 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 103 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 104 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 105 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 106 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 107 -1
//spec_const int baseTexLayout 108 0
//spec_const int intensityTextureLayout 109 0
//spec_const int materialParamsTexLayout 110 0
...
//spec_const int sc_MaxTextureImageUnits 126 0
//spec_const int sc_PointLightsCount 127 0
//spec_const int sc_RayTracedAoTextureLayout 128 0
//spec_const int sc_RayTracedDiffIndTextureLayout 129 0
//spec_const int sc_RayTracedReflectionTextureLayout 130 0
//spec_const int sc_RayTracedShadowTextureLayout 131 0
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_162=mat3(l9_3,l9_1,l9_2)*((l9_64.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_162=vec3(0.0);
...
#endif
float l9_163=clamp(l9_14.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_164=max(l9_63.xyz,vec3(0.0));
vec4 l9_165;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_165=ngsCalculateLighting(l9_164,l9_163,l9_162,l9_4,l9_5,Port_Emissive_N006,Port_Metallic_N006,clamp(l9_113.y,0.0,1.0),clamp(vec3(l9_113.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_188=l9_166.w;
l9_187=vec4(mix(vec3(1.0),l9_166.xyz,vec3(l9_188)),l9_188);
}
#else
{
vec4 l9_189;
...
{
float l9_190=l9_166.w;
float l9_191;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_191=clamp(l9_190,0.0,1.0);
}
#else
{
l9_191=l9_190;
...
#endif
l9_189=vec4(l9_166.xyz*l9_191,l9_191);
}
#else
{
l9_189=l9_166;
...
{
l9_194=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_194=vec4(0.0);
...
vec4 l9_196=outputMotionVectorsIfNeeded(varPos,max(l9_195,vec4(0.0)));
