...
//sampler sampler baseTextureSmpSC 0:16
...
//texture texture2D baseTexture 0:0:0:16
...
//spec_const bool sc_CanUseStandardDerivatives 59 0
//spec_const bool sc_CanUseTextureLod 60 0
//spec_const bool sc_DepthOnly 61 0
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 62 0
//spec_const bool sc_EnvmapSpecularHasSwappedViews 63 0
//spec_const bool sc_FramebufferFetch 64 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 65 0
//spec_const bool sc_HasDiffuseEnvmap 66 0
//spec_const bool sc_IsEditor 67 0
//spec_const bool sc_LightEstimation 68 0
...
//spec_const bool sc_SSAOEnabled 81 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTexture 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTexture 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 92 -1
//spec_const int baseTextureLayout 93 0
...
//spec_const int sc_MaxTextureImageUnits 109 0
...
#endif
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0));
float l9_4=varPackedTex.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_5=l9_4;
float l9_6=varPackedTex.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),baseTextureLayout,l9_2);
vec4 l9_25=texture2D(baseTexture,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_26=mix(baseTextureBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#if (sc_ProjectiveShadowsCaster)
{
l9_29=vec4(l9_28,Port_Opacity_N023);
}
#else
{
...
SurfaceProperties l9_39=SurfaceProperties(l9_38,Port_Opacity_N023,l9_33,varPos,l9_0,l9_30,l9_31,l9_34,l9_35,Port_SpecularAO_N023,vec3(1.0),l9_37);
vec4 l9_40=vec4(1.0);
vec3 l9_41;
vec3 l9_42;
vec3 l9_43;
...
l9_147=vec3(0.0);
l9_146=vec3(0.0);
l9_145=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_38,vec3(Port_Opacity_N023));
l9_144=1.0;
}
#else
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_168=clamp(l9_165.w*2.0,0.0,1.0);
}
#else
{
float l9_169;
...
{
l9_169=clamp(dot(l9_165.xyz,vec3(l9_165.w)),0.0,1.0);
}
#else
{
float l9_170;
...
#if (sc_BlendMode_Multiply)
{
l9_171=(1.0-dot(l9_165.xyz,vec3(0.33333001)))*l9_165.w;
}
#else
{
float l9_172;
...
{
l9_172=(1.0-clamp(dot(l9_165.xyz,vec3(1.0)),0.0,1.0))*l9_165.w;
}
#else
{
float l9_173;
#if (sc_BlendMode_ColoredGlass)
{
l9_173=clamp(dot(l9_165.xyz,vec3(1.0)),0.0,1.0)*l9_165.w;
}
#else
{
float l9_174;
#if (sc_BlendMode_Add)
{
l9_174=clamp(dot(l9_165.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_175;
...
{
l9_176=dot(l9_165.xyz,vec3(0.33333001))*l9_165.w;
}
#else
{
float l9_177;
#if (sc_BlendMode_Min)
{
l9_177=1.0-clamp(dot(l9_165.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_178;
#if (sc_BlendMode_Max)
{
l9_178=clamp(dot(l9_165.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_178=1.0;
...
#endif
l9_166=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_165.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_167);
}
#else
{
vec4 l9_179;
...
{
vec3 l9_181=sc_GetFramebufferColor().xyz;
vec3 l9_182=mix(l9_181,definedBlend(l9_181,l9_165.xyz).xyz,vec3(l9_165.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_185=l9_165.w;
l9_184=vec4(mix(vec3(1.0),l9_165.xyz,vec3(l9_185)),l9_185);
}
#else
{
vec4 l9_186;
...
#endif
l9_186=vec4(l9_165.xyz*l9_188,l9_188);
}
#else
{
l9_186=l9_165;
...
{
l9_191=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_191=vec4(0.0);
...
vec4 l9_193=outputMotionVectorsIfNeeded(varPos,max(l9_192,vec4(0.0)));
vec4 l9_194=clamp(l9_193,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_195=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_195-0.0039215689)),min(1.0,l9_195+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_196=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_196).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_197=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_196).xy);
float l9_198=packValue(l9_197);
int l9_205=int(l9_194.w*255.0);
float l9_206=packValue(l9_205);
sc_writeFragData0Internal(vec4(packValue(l9_197),packValue(l9_197),packValue(l9_197),packValue(l9_197)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_198,packValue(l9_197),packValue(l9_197),packValue(l9_197)));
sc_writeFragData2(vec4(l9_206,packValue(l9_205),packValue(l9_205),packValue(l9_205)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_209=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_209).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_214==0)
{
l9_217=texture2D(sc_OITAlpha0,l9_209);
l9_216=texture2D(sc_OITDepthLow0,l9_209);
l9_215=texture2D(sc_OITDepthHigh0,l9_209);
}
else
{
l9_217=vec4(0.0);
...
if (l9_214==1)
{
l9_220=texture2D(sc_OITAlpha1,l9_209);
l9_219=texture2D(sc_OITDepthLow1,l9_209);
l9_218=texture2D(sc_OITDepthHigh1,l9_209);
}
else
{
l9_220=l9_217;
...
if (any(notEqual(l9_218,vec4(0.0)))||any(notEqual(l9_219,vec4(0.0))))
{
int l9_221[8]=l9_210;
unpackValues(l9_218.w,l9_214,l9_221);
unpackValues(l9_218.z,l9_214,l9_221);
unpackValues(l9_218.y,l9_214,l9_221);
unpackValues(l9_218.x,l9_214,l9_221);
unpackValues(l9_219.w,l9_214,l9_221);
unpackValues(l9_219.z,l9_214,l9_221);
unpackValues(l9_219.y,l9_214,l9_221);
unpackValues(l9_219.x,l9_214,l9_221);
int l9_230[8]=l9_211;
unpackValues(l9_220.w,l9_214,l9_230);
unpackValues(l9_220.z,l9_214,l9_230);
unpackValues(l9_220.y,l9_214,l9_230);
unpackValues(l9_220.x,l9_214,l9_230);
}
l9_214++;
continue;
}
...
vec4 l9_235=texture2D(sc_OITFilteredDepthBoundsTexture,l9_209);
vec2 l9_236=l9_235.xy;
int l9_237;
#if (sc_SkinBonesCount>0)
{
l9_237=encodeDepth(((1.0-l9_235.x)*1000.0)+getDepthOrderingEpsilon(),l9_236);
}
#else
{
l9_237=0;
...
#endif
int l9_238=encodeDepth(viewSpaceDepth(),l9_236);
vec4 l9_239;
l9_239=l9_194*l9_194.w;
vec4 l9_240;
int l9_241=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_241<8)
{
int l9_242=l9_210[l9_241];
int l9_243=l9_238-l9_237;
bool l9_244=l9_242<l9_243;
bool l9_245;
if (l9_244)
{
l9_245=l9_210[l9_241]>0;
}
else
{
l9_245=l9_244;
...
if (l9_245)
{
vec3 l9_246=l9_239.xyz*(1.0-(float(l9_211[l9_241])/255.0));
l9_240=vec4(l9_246.x,l9_246.y,l9_246.z,l9_239.w);
}
else
{
l9_240=l9_239;
...
sc_writeFragData0Internal(l9_239,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
