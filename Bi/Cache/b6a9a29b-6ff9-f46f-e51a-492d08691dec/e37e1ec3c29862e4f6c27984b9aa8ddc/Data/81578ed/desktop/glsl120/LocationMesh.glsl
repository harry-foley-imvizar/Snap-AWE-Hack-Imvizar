...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_164-0.0039215689)),min(1.0,l9_164+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_166),packValue(l9_166),packValue(l9_166),packValue(l9_166)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_208,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
