...
function onTrigger() {
    ...
    tweenState.startScale = tweenState.transform.getLocalScale();
...
function updateTween() {
    ...
    var currentScale = vec3.lerp(tweenState.startScale, script.targetScale, easedProgress);
    tweenState.transform.setLocalScale(currentScale);
...
function onPaused() {
    if (tweenState.isRunning) {
        ...
        print("ScalePlayer: Paused scale tween");
    }
}
...
function onResumed() {
    if (tweenState.isRunning && tweenState.isPaused) {
        ...
        print("ScalePlayer: Resumed scale tween");
    }
}
