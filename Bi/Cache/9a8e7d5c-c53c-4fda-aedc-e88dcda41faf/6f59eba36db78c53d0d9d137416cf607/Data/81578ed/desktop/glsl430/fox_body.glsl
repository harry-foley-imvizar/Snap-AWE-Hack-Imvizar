...
#else
{
l9_164=ngsCalculateLighting(l9_163,l9_162,l9_161,l9_4,l9_5,Port_Emissive_N006,Port_Metallic_N006,clamp(l9_112.y,0.0,1.0),clamp(vec3(l9_112.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
