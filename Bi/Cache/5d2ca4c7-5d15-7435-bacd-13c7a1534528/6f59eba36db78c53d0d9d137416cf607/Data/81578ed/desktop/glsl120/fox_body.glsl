...
//spec_const bool SC_USE_UV_MIN_MAX_materialParamsTex 39 0
...
//spec_const bool materialParamsTexHasSwappedViews 48 0
//spec_const bool normalTexHasSwappedViews 49 0
...
//spec_const bool sc_CanUseStandardDerivatives 66 0
//spec_const bool sc_CanUseTextureLod 67 0
//spec_const bool sc_DepthOnly 68 0
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 69 0
//spec_const bool sc_EnvmapSpecularHasSwappedViews 70 0
//spec_const bool sc_FramebufferFetch 71 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 72 0
//spec_const bool sc_HasDiffuseEnvmap 73 0
//spec_const bool sc_IsEditor 74 0
//spec_const bool sc_LightEstimation 75 0
...
//spec_const bool sc_OITDepthPrepass 80 0
//spec_const bool sc_OITFrontLayerPass 81 0
//spec_const bool sc_OITMaxLayers4Plus1 82 0
//spec_const bool sc_OITMaxLayers8 83 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 84 0
//spec_const bool sc_ProjectiveShadowsCaster 85 0
//spec_const bool sc_ProjectiveShadowsReceiver 86 0
//spec_const bool sc_RenderAlphaToColor 87 0
//spec_const bool sc_SSAOEnabled 88 0
//spec_const bool sc_ScreenTextureHasSwappedViews 89 0
//spec_const bool sc_ShaderComplexityAnalyzer 90 0
//spec_const bool sc_TAAEnabled 91 0
//spec_const bool sc_UseFramebufferFetchMarker 92 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 101 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 103 -1
//spec_const int baseTexLayout 104 0
//spec_const int intensityTextureLayout 105 0
//spec_const int materialParamsTexLayout 106 0
//spec_const int normalTexLayout 107 0
...
//spec_const int sc_MaxTextureImageUnits 122 0
//spec_const int sc_PointLightsCount 123 0
...
#else
{
float l9_85=clamp(l9_80.y,0.0,1.0);
vec3 l9_86=ssSRGB_to_Linear(l9_83);
vec3 l9_87=normalize(l9_81);
vec3 l9_88=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_89;
#if (sc_SSAOEnabled)
{
l9_89=evaluateSSAO(varPos);
}
#else
{
l9_89=clamp(vec3(l9_80.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_90=vec3(Port_Metallic_N006);
vec3 l9_91=mix(vec3(0.039999999),l9_86*Port_Metallic_N006,l9_90);
vec3 l9_92=mix(l9_86*(1.0-Port_Metallic_N006),vec3(0.0),l9_90);
SurfaceProperties l9_93=SurfaceProperties(l9_92,l9_82,l9_87,varPos,l9_0,Port_Metallic_N006,l9_85,l9_88,l9_89,Port_SpecularAO_N006,vec3(1.0),l9_91);
vec4 l9_94=vec4(1.0);
vec3 l9_95;
vec3 l9_96;
vec3 l9_97;
...
l9_103=vec3(0.0);
l9_102=vec3(0.0);
LightingComponents l9_109;
LightProperties l9_110;
SurfaceProperties l9_111;
vec3 l9_112;
int l9_113=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_113<sc_DirectionalLightsCount)
{
LightingComponents l9_114=accumulateLight(LightingComponents(l9_102,l9_103,l9_108,l9_107,l9_105,l9_104),LightProperties(sc_DirectionalLights[l9_113].direction,sc_DirectionalLights[l9_113].color.xyz,sc_DirectionalLights[l9_113].color.w*l9_94[(l9_106<3) ? l9_106 : 3]),l9_93,l9_0);
l9_108=l9_114.indirectDiffuse;
l9_107=l9_114.indirectSpecular;
l9_106++;
l9_105=l9_114.emitted;
l9_104=l9_114.transmitted;
l9_103=l9_114.directSpecular;
l9_102=l9_114.directDiffuse;
l9_113++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_131<sc_PointLightsCount)
{
vec3 l9_133=sc_PointLights[l9_131].position-varPos;
vec3 l9_134=normalize(l9_133);
float l9_135=l9_94[(l9_132<3) ? l9_132 : 3];
float l9_136=clamp((dot(l9_134,sc_PointLights[l9_131].direction)*sc_PointLights[l9_131].angleScale)+sc_PointLights[l9_131].angleOffset,0.0,1.0);
float l9_137=(sc_PointLights[l9_131].color.w*l9_135)*(l9_136*l9_136);
float l9_138;
if (sc_PointLights[l9_131].falloffEnabled)
{
l9_138=l9_137*computeDistanceAttenuation(length(l9_133),sc_PointLights[l9_131].falloffEndDistance);
}
else
{
l9_138=l9_137;
...
l9_124=l9_132+1;
LightingComponents l9_139=accumulateLight(LightingComponents(l9_118,l9_119,l9_123,l9_122,l9_121,l9_120),LightProperties(l9_134,sc_PointLights[l9_131].color.xyz,l9_138),l9_93,l9_0);
l9_125=l9_139.directDiffuse;
l9_126=l9_139.directSpecular;
l9_127=l9_139.indirectDiffuse;
l9_128=l9_139.indirectSpecular;
l9_129=l9_139.emitted;
l9_130=l9_139.transmitted;
l9_123=l9_127;
l9_122=l9_128;
l9_132=l9_124;
l9_121=l9_129;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_143=abs(varShadowTex-vec2(0.5));
vec4 l9_144=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_143.x,l9_143.y),0.5);
l9_142=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_144.xyz,vec3(sc_ShadowColor.w)),vec3(l9_144.w*sc_ShadowDensity));
}
#else
{
l9_142=vec3(1.0);
...
#endif
l9_141=l9_115*l9_142;
l9_140=l9_116*l9_142;
}
#else
{
l9_141=l9_115;
...
{
vec2 l9_146=calcPanoramicTexCoordsFromDir(l9_87,sc_EnvmapRotation.y);
vec4 l9_147;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_148=calcSeamlessPanoramicUvsForSampling(l9_146,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_148=l9_146;
...
#endif
l9_147=sc_EnvmapSpecularSampleViewIndexBias(l9_148,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_149;
...
{
vec2 l9_150=calcSeamlessPanoramicUvsForSampling(l9_146,sc_EnvmapDiffuseSize.xy,0.0);
int l9_151;
...
#endif
l9_149=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_150,sc_EnvmapDiffuseLayout,l9_151).xy,-13.0);
}
#else
{
l9_149=sc_EnvmapSpecularSampleViewIndexBias(l9_146,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_147=l9_149;
}
#endif
l9_145=(l9_147.xyz*(1.0/l9_147.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_152;
...
float l9_156=l9_153.z;
l9_152=(((((((sc_Sh[8]*0.42904299)*((l9_154*l9_154)-(l9_155*l9_155)))+((sc_Sh[6]*0.74312502)*(l9_156*l9_156)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_154*l9_155))+(sc_Sh[7]*(l9_154*l9_156)))+(sc_Sh[5]*(l9_155*l9_156)))*0.85808599))+((((sc_Sh[3]*l9_154)+(sc_Sh[1]*l9_155))+(sc_Sh[2]*l9_156))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_152=vec3(0.0);
...
{
l9_158=l9_145+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_159=l9_145;
l9_159.x=l9_145.x+(1e-06*sc_AmbientLights[0].color.x);
l9_158=l9_159;
}
#endif
l9_157=l9_158;
...
{
l9_161=l9_157+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_162=l9_157;
l9_162.x=l9_157.x+(1e-06*sc_AmbientLights[1].color.x);
l9_161=l9_162;
}
#endif
l9_160=l9_161;
...
{
l9_164=l9_160+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_165=l9_160;
l9_165.x=l9_160.x+(1e-06*sc_AmbientLights[2].color.x);
l9_164=l9_165;
}
#endif
l9_163=l9_164;
...
{
vec3 l9_167;
l9_167=sc_LightEstimationData.ambientLight;
vec3 l9_168;
int l9_169=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_169<sc_LightEstimationSGCount)
{
float l9_170=dot(sc_LightEstimationData.sg[l9_169].axis,l9_87);
float l9_171=exp(-sc_LightEstimationData.sg[l9_169].sharpness);
float l9_172=l9_171*l9_171;
float l9_173=1.0/sc_LightEstimationData.sg[l9_169].sharpness;
float l9_174=(1.0+(2.0*l9_172))-l9_173;
float l9_175=sqrt(1.0-l9_174);
float l9_176=0.36000001*l9_170;
float l9_177=(1.0/(4.0*0.36000001))*l9_175;
float l9_178=l9_176+l9_177;
float l9_179;
if (step(abs(l9_176),l9_177)>0.5)
{
l9_179=(l9_178*l9_178)/l9_175;
}
else
{
l9_179=clamp(l9_170,0.0,1.0);
}
l9_168=l9_167+((((sc_LightEstimationData.sg[l9_169].color/vec3(sc_LightEstimationData.sg[l9_169].sharpness))*6.2831855)*((l9_174*l9_179)+(((l9_171-l9_172)*l9_173)-l9_172)))/vec3(3.1415927));
l9_167=l9_168;
l9_169++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_181=clamp(pow(l9_85,0.66666669),0.0,1.0)*5.0;
vec2 l9_182=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_87,reflect(-l9_0,l9_87),l9_85),sc_EnvmapRotation.y);
vec4 l9_183;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_184=floor(l9_181);
float l9_185=ceil(l9_181);
l9_183=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_182,sc_EnvmapSpecularSize.xy,l9_184),sc_EnvmapSpecularGetStereoViewIndex(),l9_184),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_182,sc_EnvmapSpecularSize.xy,l9_185),sc_EnvmapSpecularGetStereoViewIndex(),l9_185),vec4(l9_181-l9_184));
}
#else
{
l9_183=sc_EnvmapSpecularSampleViewIndexLevel(l9_182,sc_EnvmapSpecularGetStereoViewIndex(),l9_181);
}
#endif
l9_180=vec3(0.0)+((((l9_183.xyz*(1.0/l9_183.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_93,abs(dot(l9_87,l9_0))));
}
#else
{
l9_180=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_187=clamp(l9_85*l9_85,0.0099999998,1.0);
vec3 l9_188;
l9_188=sc_LightEstimationData.ambientLight*l9_91;
int l9_189=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_189<sc_LightEstimationSGCount)
{
float l9_190=l9_187*l9_187;
vec3 l9_191=reflect(-l9_0,l9_87);
float l9_192=dot(l9_87,l9_0);
float l9_193=(2.0/l9_190)/(4.0*max(l9_192,9.9999997e-05));
float l9_194=length((l9_191*l9_193)+(sc_LightEstimationData.sg[l9_189].axis*sc_LightEstimationData.sg[l9_189].sharpness));
float l9_195=clamp(dot(l9_87,l9_191),0.0,1.0);
float l9_196=clamp(l9_192,0.0,1.0);
float l9_197=1.0-l9_190;
l9_188+=((((((((vec3(1.0/(3.1415927*l9_190))*exp((l9_194-l9_193)-sc_LightEstimationData.sg[l9_189].sharpness))*sc_LightEstimationData.sg[l9_189].color)*6.2831855)*(1.0-exp((-2.0)*l9_194)))/vec3(l9_194))*((1.0/(l9_195+sqrt(l9_190+((l9_197*l9_195)*l9_195))))*(1.0/(l9_196+sqrt(l9_190+((l9_197*l9_196)*l9_196))))))*(l9_91+((vec3(1.0)-l9_91)*pow(1.0-clamp(dot(l9_191,normalize(l9_191+l9_0)),0.0,1.0),5.0))))*l9_195);
l9_189++;
continue;
}
else
...
l9_201=vec3(0.0);
l9_200=vec3(0.0);
l9_199=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_92,vec3(l9_82));
l9_198=1.0;
}
#else
{
...
#endif
vec3 l9_203=l9_200*l9_89;
vec3 l9_204=l9_201+l9_203;
vec3 l9_205=l9_92*l9_204;
vec3 l9_206=l9_186*Port_SpecularAO_N006;
vec3 l9_207=l9_140+l9_206;
vec3 l9_208;
if (l9_202)
{
l9_208=l9_205*srgbToLinear(l9_198);
}
else
{
l9_208=l9_205;
}
vec3 l9_209=l9_208+l9_207;
vec3 l9_210=(l9_209+l9_88)+l9_199;
float l9_211=l9_210.x;
vec4 l9_212=vec4(l9_211,l9_210.yz,l9_198);
vec4 l9_213;
#if (sc_IsEditor)
{
vec4 l9_214=l9_212;
l9_214.x=l9_211+((l9_89.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_213=l9_214;
}
#else
{
...
{
vec3 l9_216=l9_213.xyz*1.8;
vec3 l9_217=(l9_213.xyz*(l9_216+vec3(1.4)))/((l9_213.xyz*(l9_216+vec3(0.5)))+vec3(1.5));
l9_215=vec4(l9_217.x,l9_217.y,l9_217.z,l9_213.w);
}
#else
{
l9_215=l9_213;
...
#endif
vec3 l9_218=vec3(linearToSrgb(l9_215.x),linearToSrgb(l9_215.y),linearToSrgb(l9_215.z));
l9_84=vec4(l9_218.x,l9_218.y,l9_218.z,l9_215.w);
}
#endif
vec4 l9_219=max(l9_84,vec4(0.0));
vec4 l9_220;
#if (sc_ProjectiveShadowsCaster)
{
float l9_221;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_222=clamp(l9_219.w*2.0,0.0,1.0);
}
#else
{
float l9_223;
...
{
l9_223=clamp(dot(l9_219.xyz,vec3(l9_219.w)),0.0,1.0);
}
#else
{
float l9_224;
...
#if (sc_BlendMode_Multiply)
{
l9_225=(1.0-dot(l9_219.xyz,vec3(0.33333001)))*l9_219.w;
}
#else
{
float l9_226;
...
{
l9_226=(1.0-clamp(dot(l9_219.xyz,vec3(1.0)),0.0,1.0))*l9_219.w;
}
#else
{
float l9_227;
#if (sc_BlendMode_ColoredGlass)
{
l9_227=clamp(dot(l9_219.xyz,vec3(1.0)),0.0,1.0)*l9_219.w;
}
#else
{
float l9_228;
#if (sc_BlendMode_Add)
{
l9_228=clamp(dot(l9_219.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_229;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_229=clamp(dot(l9_219.xyz,vec3(1.0)),0.0,1.0)*l9_219.w;
}
#else
{
float l9_230;
...
{
l9_230=dot(l9_219.xyz,vec3(0.33333001))*l9_219.w;
}
#else
{
float l9_231;
#if (sc_BlendMode_Min)
{
l9_231=1.0-clamp(dot(l9_219.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_232;
#if (sc_BlendMode_Max)
{
l9_232=clamp(dot(l9_219.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_232=1.0;
...
#endif
l9_220=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_219.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_221);
}
#else
{
vec4 l9_233;
...
{
vec3 l9_235=sc_GetFramebufferColor().xyz;
vec3 l9_236=mix(l9_235,definedBlend(l9_235,l9_219.xyz).xyz,vec3(l9_219.w));
vec4 l9_237=vec4(l9_236.x,l9_236.y,l9_236.z,vec4(0.0).w);
l9_237.w=1.0;
l9_234=l9_237;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_239=l9_219.w;
l9_238=vec4(mix(vec3(1.0),l9_219.xyz,vec3(l9_239)),l9_239);
}
#else
{
vec4 l9_240;
...
{
float l9_241=l9_219.w;
float l9_242;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_242=clamp(l9_241,0.0,1.0);
}
#else
{
l9_242=l9_241;
...
#endif
l9_240=vec4(l9_219.xyz*l9_242,l9_242);
}
#else
{
l9_240=l9_219;
...
{
l9_245=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_245=vec4(0.0);
...
vec4 l9_247=outputMotionVectorsIfNeeded(varPos,max(l9_246,vec4(0.0)));
vec4 l9_248=clamp(l9_247,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_249=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_249-0.0039215689)),min(1.0,l9_249+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_251=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_250).xy);
float l9_252=packValue(l9_251);
int l9_259=int(l9_248.w*255.0);
float l9_260=packValue(l9_259);
sc_writeFragData0Internal(vec4(packValue(l9_251),packValue(l9_251),packValue(l9_251),packValue(l9_251)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_252,packValue(l9_251),packValue(l9_251),packValue(l9_251)));
sc_writeFragData2(vec4(l9_260,packValue(l9_259),packValue(l9_259),packValue(l9_259)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_263=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_263).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_268==0)
{
l9_271=texture2D(sc_OITAlpha0,l9_263);
l9_270=texture2D(sc_OITDepthLow0,l9_263);
l9_269=texture2D(sc_OITDepthHigh0,l9_263);
}
else
{
l9_271=vec4(0.0);
...
if (l9_268==1)
{
l9_274=texture2D(sc_OITAlpha1,l9_263);
l9_273=texture2D(sc_OITDepthLow1,l9_263);
l9_272=texture2D(sc_OITDepthHigh1,l9_263);
}
else
{
l9_274=l9_271;
...
if (any(notEqual(l9_272,vec4(0.0)))||any(notEqual(l9_273,vec4(0.0))))
{
int l9_275[8]=l9_264;
unpackValues(l9_272.w,l9_268,l9_275);
unpackValues(l9_272.z,l9_268,l9_275);
unpackValues(l9_272.y,l9_268,l9_275);
unpackValues(l9_272.x,l9_268,l9_275);
unpackValues(l9_273.w,l9_268,l9_275);
unpackValues(l9_273.z,l9_268,l9_275);
unpackValues(l9_273.y,l9_268,l9_275);
unpackValues(l9_273.x,l9_268,l9_275);
int l9_284[8]=l9_265;
unpackValues(l9_274.w,l9_268,l9_284);
unpackValues(l9_274.z,l9_268,l9_284);
unpackValues(l9_274.y,l9_268,l9_284);
unpackValues(l9_274.x,l9_268,l9_284);
}
l9_268++;
continue;
}
...
vec4 l9_289=texture2D(sc_OITFilteredDepthBoundsTexture,l9_263);
vec2 l9_290=l9_289.xy;
int l9_291;
#if (sc_SkinBonesCount>0)
{
l9_291=encodeDepth(((1.0-l9_289.x)*1000.0)+getDepthOrderingEpsilon(),l9_290);
}
#else
{
l9_291=0;
...
#endif
int l9_292=encodeDepth(viewSpaceDepth(),l9_290);
vec4 l9_293;
l9_293=l9_248*l9_248.w;
vec4 l9_294;
int l9_295=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_295<8)
{
int l9_296=l9_264[l9_295];
int l9_297=l9_292-l9_291;
bool l9_298=l9_296<l9_297;
bool l9_299;
if (l9_298)
{
l9_299=l9_264[l9_295]>0;
}
else
{
l9_299=l9_298;
...
if (l9_299)
{
vec3 l9_300=l9_293.xyz*(1.0-(float(l9_265[l9_295])/255.0));
l9_294=vec4(l9_300.x,l9_300.y,l9_300.z,l9_293.w);
}
else
{
l9_294=l9_293;
...
sc_writeFragData0Internal(l9_293,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
