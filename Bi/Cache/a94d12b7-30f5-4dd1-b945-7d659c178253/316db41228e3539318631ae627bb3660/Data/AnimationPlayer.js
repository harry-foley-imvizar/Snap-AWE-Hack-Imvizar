...
function onTrigger() {
    ...
    if (clips && clips.length > script.clipIndex) {
        ...
        if (script.enableClip) {
            ...
            print("AnimationPlayer: Started clip " + script.clipIndex + " (" + clipName + ") - Speed: " + script.playbackSpeed + ", Loop: " + script.loopAnimation + ", Weight: " + script.clipWeight);
        } else {
            print("AnimationPlayer: Clip " + script.clipIndex + " (" + clipName + ") is disabled");
        }
