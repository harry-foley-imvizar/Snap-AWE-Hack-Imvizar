...
//spec_const bool opacityTexHasSwappedViews 46 0
...
//spec_const bool sc_BlendMode_Software 62 0
...
//spec_const bool sc_ProxyAlphaOne 78 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 88 -1
...
//spec_const int baseTexLayout 92 0
//spec_const int intensityTextureLayout 93 0
//spec_const int opacityTexLayout 94 0
...
uniform vec4 Port_Default_N032;
uniform float Port_Default_N029;
uniform int PreviewEnabled;
...
#if (Tweak_N121)
{
vec2 l9_3=l9_0-Port_Center_N010;
vec2 l9_4=(l9_3*vec2(uvScale))+Port_Center_N010;
vec4 l9_5;
#if (baseTexLayout==2)
{
...
#else
{
l9_2=Port_Default_N032;
}
#endif
vec4 l9_54=baseColor*l9_2;
float l9_55;
#if (Tweak_N308)
{
vec2 l9_56=l9_0-Port_Center_N010;
vec2 l9_57=(l9_56*vec2(uvScale))+Port_Center_N010;
vec4 l9_58;
#if (opacityTexLayout==2)
{
bool l9_59=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_60=l9_57.x;
sc_SoftwareWrapEarly(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_61=l9_60;
float l9_62=l9_57.y;
sc_SoftwareWrapEarly(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_63=l9_62;
vec2 l9_64;
float l9_65;
...
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_67=l9_61;
float l9_68=1.0;
sc_ClampUV(l9_67,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_66,l9_68);
float l9_69=l9_67;
float l9_70=l9_68;
bool l9_71;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_71=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_71=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_72=l9_63;
float l9_73=l9_70;
sc_ClampUV(l9_72,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_71,l9_73);
l9_65=l9_73;
...
#endif
vec2 l9_74=sc_TransformUV(l9_64,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_75=l9_74.x;
float l9_76=l9_65;
sc_SoftwareWrapLate(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_59,l9_76);
float l9_77=l9_74.y;
float l9_78=l9_76;
sc_SoftwareWrapLate(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_59,l9_78);
float l9_79=l9_78;
vec3 l9_80=sc_SamplingCoordsViewToGlobal(vec2(l9_75,l9_77),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_81=texture(opacityTexArrSC,l9_80,0.0);
vec4 l9_82;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_82=mix(opacityTexBorderColor,l9_81,vec4(l9_79));
}
#else
{
l9_82=l9_81;
...
#else
{
l9_55=Port_Default_N029;
}
#endif
float l9_107=l9_54.w*l9_55;
vec4 l9_108=vec4(l9_54.x,l9_54.y,l9_54.z,vec4(0.0).w);
l9_108.w=l9_107;
#if (sc_BlendMode_AlphaTest)
{
if (l9_107<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_107<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_109,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_111;
...
{
l9_113=clamp(l9_107*2.0,0.0,1.0);
}
#else
{
float l9_114;
...
{
l9_114=clamp(dot(l9_108.xyz,vec3(l9_107)),0.0,1.0);
}
#else
{
float l9_115;
...
{
l9_116=(1.0-dot(l9_108.xyz,vec3(0.33333001)))*l9_107;
}
#else
{
float l9_117;
...
{
l9_117=(1.0-clamp(dot(l9_108.xyz,vec3(1.0)),0.0,1.0))*l9_107;
}
#else
{
float l9_118;
...
{
l9_118=clamp(dot(l9_108.xyz,vec3(1.0)),0.0,1.0)*l9_107;
}
#else
{
float l9_119;
#if (sc_BlendMode_Add)
{
l9_119=clamp(dot(l9_108.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_120;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_120=clamp(dot(l9_108.xyz,vec3(1.0)),0.0,1.0)*l9_107;
}
#else
{
float l9_121;
...
{
l9_121=dot(l9_108.xyz,vec3(0.33333001))*l9_107;
}
#else
{
float l9_122;
#if (sc_BlendMode_Min)
{
l9_122=1.0-clamp(dot(l9_108.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_123;
#if (sc_BlendMode_Max)
{
l9_123=clamp(dot(l9_108.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_123=1.0;
...
#endif
l9_111=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_108.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_112);
}
#else
{
vec4 l9_124;
...
#if (sc_FramebufferFetch)
{
vec4 l9_127=sc_readFragData0_Platform();
vec4 l9_128;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_129=l9_127;
l9_129.x=l9_127.x+_sc_framebufferFetchMarker;
l9_128=l9_129;
}
#else
{
...
{
l9_132=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_130,sc_ScreenTextureLayout,l9_131),0.0);
}
#else
{
l9_132=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_130,sc_ScreenTextureLayout,l9_131).xy,0.0);
}
#endif
l9_126=l9_132;
}
...
{
vec4 l9_134=l9_126;
l9_134.x=l9_126.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_133=l9_134;
}
#else
{
...
#endif
vec3 l9_135=mix(l9_133.xyz,definedBlend(l9_133.xyz,l9_108.xyz).xyz,vec3(l9_107));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_137=vec4(mix(vec3(1.0),l9_108.xyz,vec3(l9_107)),l9_107);
}
#else
{
vec4 l9_138;
...
#endif
l9_138=vec4(l9_108.xyz*l9_139,l9_139);
}
#else
{
l9_138=l9_108;
...
{
l9_142=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_142=vec4(0.0);
...
vec4 l9_144=outputMotionVectorsIfNeeded(varPos,max(l9_143,vec4(0.0)));
vec4 l9_145=clamp(l9_144,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_146=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_146-0.0039215689)),min(1.0,l9_146+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_147).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_148=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_147).xy);
float l9_149=packValue(l9_148);
int l9_156=int(l9_145.w*255.0);
float l9_157=packValue(l9_156);
sc_writeFragData0Internal(vec4(packValue(l9_148),packValue(l9_148),packValue(l9_148),packValue(l9_148)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_149,packValue(l9_148),packValue(l9_148),packValue(l9_148)));
sc_writeFragData2(vec4(l9_157,packValue(l9_156),packValue(l9_156),packValue(l9_156)));
...
if (l9_165==0)
{
l9_168=texture(sc_OITAlpha0,l9_160);
l9_167=texture(sc_OITDepthLow0,l9_160);
l9_166=texture(sc_OITDepthHigh0,l9_160);
}
else
{
l9_168=vec4(0.0);
...
if (l9_165==1)
{
l9_171=texture(sc_OITAlpha1,l9_160);
l9_170=texture(sc_OITDepthLow1,l9_160);
l9_169=texture(sc_OITDepthHigh1,l9_160);
}
else
{
l9_171=l9_168;
...
{
int l9_172[8]=l9_161;
unpackValues(l9_169.w,l9_165,l9_172);
unpackValues(l9_169.z,l9_165,l9_172);
unpackValues(l9_169.y,l9_165,l9_172);
unpackValues(l9_169.x,l9_165,l9_172);
unpackValues(l9_170.w,l9_165,l9_172);
unpackValues(l9_170.z,l9_165,l9_172);
unpackValues(l9_170.y,l9_165,l9_172);
unpackValues(l9_170.x,l9_165,l9_172);
int l9_181[8]=l9_162;
unpackValues(l9_171.w,l9_165,l9_181);
unpackValues(l9_171.z,l9_165,l9_181);
unpackValues(l9_171.y,l9_165,l9_181);
unpackValues(l9_171.x,l9_165,l9_181);
}
l9_165++;
continue;
}
...
vec4 l9_186=texture(sc_OITFilteredDepthBoundsTexture,l9_160);
vec2 l9_187=l9_186.xy;
int l9_188;
#if (sc_SkinBonesCount>0)
{
l9_188=encodeDepth(((1.0-l9_186.x)*1000.0)+getDepthOrderingEpsilon(),l9_187);
}
#else
{
l9_188=0;
...
#endif
int l9_189=encodeDepth(viewSpaceDepth(),l9_187);
vec4 l9_190;
l9_190=l9_145*l9_145.w;
vec4 l9_191;
int l9_192=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_192<8)
{
int l9_193=l9_161[l9_192];
int l9_194=l9_189-l9_188;
bool l9_195=l9_193<l9_194;
bool l9_196;
if (l9_195)
{
l9_196=l9_161[l9_192]>0;
}
else
{
l9_196=l9_195;
...
if (l9_196)
{
vec3 l9_197=l9_190.xyz*(1.0-(float(l9_162[l9_192])/255.0));
l9_191=vec4(l9_197.x,l9_197.y,l9_197.z,l9_190.w);
}
else
{
l9_191=l9_190;
